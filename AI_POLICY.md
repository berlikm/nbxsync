...
We support using AI (i.e., LLMs) as tools when contributing to nbxSync. However, you are responsible for any contributions you submit, and we are responsible for any contributions we merge and release. We hold a high bar for all contributions to nbxSync.
...
Contributions that do not follow this policy will be closed. Repeated violations may result in being blocked from contributing to nbxSync. If you believe your contribution was closed in error, you are welcome to reach out to a maintainer to discuss.