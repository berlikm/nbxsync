...
class FirewallRoleMacroTests(unittest.TestCase):
    ...
    def test_observability_path_and_interfaces_are_vdom_maps(self):
        ...
        self.assertEqual(ni_fields.get('thresholds.0.color'), 'FF465C')
        self.assertEqual(ni_fields.get('thresholds.0.threshold'), '0')
        self.assertEqual(ni_fields.get('thresholds.1.color'), '0EC9AC')
        self.assertEqual(ni_fields.get('thresholds.1.threshold'), '1')
