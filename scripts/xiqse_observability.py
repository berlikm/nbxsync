...
LINUX_AGENT_TEMPLATE_NAME = 'Linux by Zabbix agent'
AGENT_SNMP_CONFIGURATION_GROUP = 'Agent+SNMP'
LEGACY_NAC_CONFIGURATION_GROUP = 'SNMP Monitoring'
LEGACY_XIQSE_CREDENTIAL_CONFIGURATION_GROUPS = ('XIQ-SE Client API + Agent',)
