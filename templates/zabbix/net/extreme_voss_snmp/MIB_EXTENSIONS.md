# Extreme VOSS by SNMP — MIB extensions
...
| Optics / DOM LLD | `optic.discovery` — vendor/PN/SN/λ/temp/TX/RX/bias/DDM | `71.1.1.*` | empty (no optics) |
| LLDP neighbors | `lldp.discovery` — sysname/port/chassis/desc | `1.0.8802.1.1.2.1.4.1.1.*` | needs peers |
| PSU detail | `psu.detail.discovery` — status/SN/PN/watts | `4.8.2.1.*` | PASS (ids 1–2) |
...
| SNMP traps | fan/PSU/overheat/CPU/ISIS adj/LAG | `snmptrap["rcn…"]` | needs trap config |
