# Extreme VOSS by SNMP — live verification checklist
...
|---|---|---|---|
| `vm.memory.available[rcKhiSlotMemFree.{#SNMPINDEX}]` | `...1.1.7.{slot}` | | units KB→B ×1024 |
...
| `rcPortName` shows same / truncated | SIZE ≤ 42 |
