...
def build_scalar_items() -> str:
    ...
    chunks.append(
        item_snmp(
            ...
            value_type="FLOAT",
            units="%",
            description="MIB: rcKhiSlotCpu1MinAve — 1-minute average CPU util for slot 1.",
            tags=[("component", "cpu")],
        )
    )
    chunks.append(
        item_snmp(
            ...
            value_type="FLOAT",
            units="%",
            description="MIB: rcKhiSlotCpu5MinAve — 5-minute average CPU util for slot 1.",
            tags=[("component", "cpu")],
            triggers=[
                {
    ...
    chunks.append(
        item_snmp(
            ...
            value_type="FLOAT",
            units="%",
            description="MIB: rcKhiSlotMem5MinAve — 5-minute average memory util for slot 1.",
    ...
    chunks.append(
        item_snmp(
            ...
            OID["vistStatus"],
            description="MIB: rcVirtualIstSessionStatus — up(1) down(2).",
    ...
    chunks.append(
        item_snmp(
            ...
            OID["istStatus"],
            description="MIB: rcMltIstSessionStatus — up(1) down(2).",
    ...
    chunks.append(
        item_snmp(
            ...
            OID["plsbEnable"],
            description="MIB: rcPlsbGlobalEnable — enable(1) disable(2).",
...
def build_discovery_rules() -> str:
    ...
    opt_items = "".join(
        [
            ...
            proto(
                ...
                units="uA",
                delay="1m",
                description="MIB: rcPlugOptModBias (0.1 µA units).",
    ...
    rules.append(
        discovery_rule(
            ...
            opt_items,
            "RAPID-CITY rcPlugOptModTable — optics / DOM (empty on VOSS-VM without optics).",
        )
    )
    ...
    rules.append(
        discovery_rule(
            ...
            lldp_items,
            "LLDP-MIB lldpRemTable — neighbors (needs LLDP peers).",
        )
    )
    ...
    card_items = "".join(
        [
            ...
            proto(
                ...
                delay="3m",
                description="MIB: rcCardOperStatus — up(1) down(2) testing(3) unknown(4) dormant(5).",
    ...
    rules.append(
        discovery_rule(
            ...
            card_items,
            "RAPID-CITY rcCardTable — may be empty on fixed VOSS-VM.",
        )
    )
    ...
    isis_c = "".join(
        [
            proto(
                ...
                delay="1m",
                description="MIB: rcIsisCircuitOperState — unknown(0) up(1) down(2).",
    ...
    rules.append(
        discovery_rule(
            ...
            isis_a,
            "RAPID-CITY rcIsisAdjTable — SPBM/ISIS neighbors.",
        )
    )
    ...
    plsb = "".join(
        [
            ...
            proto(
                ...
                delay="1m",
                description="MIB: rcIsisPlsbState — enable(1) disable(2).",
                valuemap="RAPID-CITY::EnableValue",
                tags=[("component", "fabric")],
            ),
        ]
    ...
    mlt = "".join(
        [
            ...
            proto(
                ...
                delay="1m",
                description="MIB: rcMltAggOperState — enable(1) disable(2).",
                valuemap="RAPID-CITY::EnableValue",
                tags=[("component", "network")],
                trigger_prototypes=[
                    {
    ...
    rules.append(
        discovery_rule(
            ...
            mlt,
            "RAPID-CITY rcMltTable — MLT/SMLT aggregates.",
        )
    )
...
def build_macros() -> str:
    macros = [
        ...
        ("{$OPTIC.RX.POWER.MIN}", "1", "Minimum optic RX power in µW (0 ignored)"),
    ]
    out = []
...
def inject_if_prototypes(text: str) -> str:
    ...
    # insert after the ifType prototype block — find next item or graph_prototypes
    ...
    extra = "".join(
        [
            proto(
                ...
                delay="5m",
                description="MIB: rcPortNumStateTransition — link state change count.",
                tags=[("component", "network")],
                trigger_prototypes=[
                    {
...
def main() -> None:
    ...
    # Update description
    text = text.replace(
        "RAPID-CITY (enterprises.2272) — rcKhi, rcChassis, rcVossSystem, rcSystem\n",
        "RAPID-CITY (enterprises.2272) — rcKhi, rcChassis, rcVossSystem, rcSystem,\n"
    ...
    # Insert macros after existing macros block start — append before dashboards
    d_anchor = "    dashboards:\n"
    ...
    flap_macro = """    - macro: '{$IF.FLAP.WARN}'
      value: '0'
      description: 'Link-flap warning — fire when rcPortNumStateTransition change exceeds this (context-capable).'
"""
