...
| AD DS Directory Services counters | Stock Windows by agent is OS + service **state**. NTDS/LDAP/DRA need a companion — [notes/ad-ds-coverage.md](notes/ad-ds-coverage.md). Server estate, not 01/02 |
