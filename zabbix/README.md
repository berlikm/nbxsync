...
| `templates/mssql_observability/` | MSSQL Observability | **built** — named-instance Agent 2 companion; link next to stock; YAML importable — [notes/mssql-agent2-instances.md](notes/mssql-agent2-instances.md) |
