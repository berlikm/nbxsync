...
|---|---|---|
| `templates/extreme_voss_snmp/` | Extreme VOSS by SNMP | imported; **Health** dashboard; SNMP-dead **Warning**; `USW` link-down **High**; ISIS/card High gated; ICMP loss **off** — [01](01-extreme-switching.md) |
