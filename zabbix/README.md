...
| `templates/mssql_observability/` | MSSQL Observability | **built** — named-instance Agent 2 companion with flattened DB + AG local-DB LLD; link next to stock — [notes/mssql-agent2-instances.md](notes/mssql-agent2-instances.md) |
