...
| `templates/mssql_observability/` | MSSQL Observability | **built** — named-instance Agent 2 companion with flattened DB + AG local-DB LLD; `--apply-mssql` plus optional zerotouch assign — [notes/mssql-agent2-instances.md](notes/mssql-agent2-instances.md) |
