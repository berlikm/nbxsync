...
| `templates/sap_sensirion/` | SAP template from Sensirion + SAP ME from Sensirion | **built**; openSUSE HANA (ST22 / sapcontrol; OS is Linux by SNMP) vs Windows ME (PowerShell sapcontrol + jstart); `--apply-sap` — [sapcontrol](templates/sap_sensirion/SAPCONTROL.md) |
