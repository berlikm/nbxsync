...
| IIS | couple of Windows web servers | ⚠️ stock template exists | link on Device | **IIS by Zabbix agent** 7.0 — [notes/iis-coverage.md](notes/iis-coverage.md); not zerotouched. **No cert expiry** in IIS — add **Website certificate by Zabbix agent 2** |
