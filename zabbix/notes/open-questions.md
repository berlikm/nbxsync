...
- [ ] **IIS site certs** — IIS template does **not** check expiry. Link **Website certificate by Zabbix agent 2**; Agent 2 on those boxes; `{$CERT.EXPIRY.WARN}=30`; one hostname per 7.0 host.
