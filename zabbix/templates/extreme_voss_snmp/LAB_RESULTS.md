Extreme VOSS by SNMP ΓÇö live lab results
=======================================
Date: 2026-08-05
...
Zabbix: 7.0.29 ΓÇö template imported; host voss-lab linked

Boot notes
----------
- qemu64: FIPS crypto Illegal instruction ΓåÆ process death
...
PASS sysUpTime.0
FAIL hrSystemUptime.0 = No Such Object (item preprocessing ΓåÆ 0; restart trigger uses sysUpTime fallback)
...
LLD / tables
------------
PASS Slot memory/CPU (rcKhiSlot*) ΓÇö Zabbix collected mem used/free/util + CPU
PASS PSU ΓÇö OperStatus 3=up for PS1/PS2; Zabbix items OK
FAIL Fan table rcChasFan* ΓÇö No Such Object on Virtual VOSS (keep LLD for hardware)
PASS Temperature LLD ΓÇö 7 sensors; value 0┬░C on VM; status normal(1)
PASS IF-MIB ΓÇö ports 1/1.. map to ifIndex 192+; traffic/status collected in Zabbix (334 items)
PASS ifAlias ΓÇö Mgmt-oob1 / Mgmt-vlan populated

Port-identity canary
--------------------
CLI: interface gigabitEthernet 1/1 ; name USW-ID01
ΓåÆ ifAlias.192 = "USW-ID01"  PASS
ΓåÆ rcPortName.192 = ""       empty (do not rely on rcPortName for grammar)
