...
def build_parent() -> Doc:
    ...
    snmp(doc, 'Serial number', FN_SYS_SERIAL, 'system.hw.serialnumber', delay='1h', value_type='CHAR', trends='0', history='7d', inventory='SERIALNO_A', description='MIB: FORTINET-CORE-MIB fnSysSerial. Do not DISCARD_UNCHANGED longer than nodata(2h) — a stable serial looked missing.', triggers=[
